...
async function measure(page){
  return page.evaluate(() => {
    ...
    return {
      ...
      leftDiscards: all('#left-discards .tile.hand-face.opp-hand.opp-disc:not(.back), .west-discards .tile.hand-face.opp-hand.opp-disc:not(.back)'),
      rightDiscards: all('#right-discards .tile.hand-face.opp-hand.opp-disc:not(.back), .east-discards .tile.hand-face.opp-hand.opp-disc:not(.back)'),
      ...
      leftDiscardGaps: pairGaps('#left-discards .tile.hand-face.opp-hand.opp-disc, .west-discards .tile.hand-face.opp-hand.opp-disc'),
      rightDiscardGaps: pairGaps('#right-discards .tile.hand-face.opp-hand.opp-disc, .east-discards .tile.hand-face.opp-hand.opp-disc'),
